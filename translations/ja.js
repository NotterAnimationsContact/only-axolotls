export default {
  "lang": "ja",
  "languageLabel": "言語",
  "pageTitle": "Only Axolotls — 公式ゲームガイド",
  "description": "Official Only Axolotls game guide — mechanics, breeding, probabilities, levels, axolotl abilities, effects and more.",
  "hero.eyebrow": "公式ゲームガイド",
  "hero.title": "Only Axolotls",
  "hero.subtitle": "水槽、ウーパールーパー、繁殖、バトル、進行、確率について知っておくべきことをすべて紹介します。",
  "hero.note": "このガイドは現在の最終版ゲームシステムと数値を説明しています。",
  "basics.title": "Only Axolotls の仕組み",
  ...
  "basics.grid1.title": "8パーツ",
  "basics.grid1.p": "各ウーパールーパーは独立して決定される8つのパーツで構成されます。",
  "basics.grid2.title": "6つのレア度",
  "basics.grid2.p": "コモン、アンコモン、レア、エピック、レジェンダリー、Xólotl。",
  "basics.grid3.title": "進行",
  "basics.grid3.p": "水槽レベルで新しいウーパールーパー、種、容量、拡張が解放されます。",
  "basics.grid4.title": "バトル",
  "basics.grid4.p": "パーツはステータスや状態異常を与えます。",
  "breeding.title": "繁殖とパーツ継承",
  "breeding.p1": "When two axolotls reproduce, every one of their eight pieces is resolved independently.",
  "breeding.mother": "母 35%",
  "breeding.father": "父 35%",
  "breeding.mutation": "変異 30%",
  ...
  "breeding.genderTitle": "誕生時の性別",
  "breeding.genderP": "生まれたウーパールーパーは<strong>50%でメス</strong>、<strong>50%でオス</strong>です。",
  "timers.title": "繁殖時間とジェムコスト",
  ...
  "visitors.unlocked": "解放済みレア度",
  "visitors.chance": "レア度ごとの確率",
  ...
  "love.multipleTitle": "複数の敵が加入した場合",
  ...
  "effects.effect": "効果",
  "effects.result": "結果",
  "abilities.title": "ウーパールーパーのパーツ能力",
