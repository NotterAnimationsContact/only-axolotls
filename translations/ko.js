export default {
  "lang": "ko",
  "languageLabel": "언어",
  "pageTitle": "Only Axolotls — 공식 게임 가이드",
  "description": "Official Only Axolotls game guide — mechanics, breeding, probabilities, levels, axolotl abilities, effects and more.",
  "hero.eyebrow": "공식 게임 가이드",
  "hero.title": "Only Axolotls",
  "hero.subtitle": "수족관, 아홀로틀, 번식, 전투, 진행도와 확률에 대해 알아야 할 모든 내용을 확인하세요.",
  "hero.note": "이 가이드는 현재 최종 게임 시스템과 수치를 설명합니다.",
  "basics.title": "Only Axolotls의 작동 방식",
  ...
  "basics.grid1.title": "8개 파츠",
  "basics.grid1.p": "각 아홀로틀은 독립적으로 결정되는 8개의 파츠로 구성됩니다.",
  "basics.grid2.title": "6가지 희귀도",
  "basics.grid2.p": "일반, 고급, 희귀, 에픽, 전설, Xólotl.",
  "basics.grid3.title": "진행도",
  "basics.grid3.p": "수족관 레벨을 올리면 새로운 아홀로틀, 씨앗, 수용량과 확장이 해금됩니다.",
  "basics.grid4.title": "전투",
  "basics.grid4.p": "파츠는 능력치와 상태 효과를 부여할 수 있습니다.",
  "breeding.title": "번식 및 파츠 상속",
  "breeding.p1": "When two axolotls reproduce, every one of their eight pieces is resolved independently.",
  "breeding.mother": "어미 35%",
  "breeding.father": "아비 35%",
  "breeding.mutation": "돌연변이 30%",
  ...
  "breeding.genderTitle": "출생 성별",
  "breeding.genderP": "모든 새끼 아홀로틀은 <strong>암컷 50%</strong>, <strong>수컷 50%</strong>의 확률을 가집니다.",
  "timers.title": "번식 시간 및 젬 비용",
  ...
  "visitors.unlocked": "해금된 희귀도",
  "visitors.chance": "희귀도별 확률",
  ...
  "love.multipleTitle": "여러 적이 합류하는 경우",
  ...
  "legal.title": "개인정보 보호 및 저작권",
  "legal.privacyTitle": "개인정보 보호정책",
