export default {
  ...
  "pageTitle": "Only Axolotls — Guide officiel du jeu",
  "description": "Official Only Axolotls game guide — mechanics, breeding, probabilities, levels, axolotl abilities, effects and more.",
  "hero.eyebrow": "GUIDE OFFICIEL DU JEU",
  "hero.title": "Only Axolotls",
  "hero.subtitle": "Tout ce que vous devez savoir sur votre aquarium, les axolotls, la reproduction, les combats, la progression et les probabilités.",
  "hero.note": "Ce guide décrit les systèmes et valeurs actuels de la version finale du jeu.",
  "basics.title": "Comment fonctionne Only Axolotls",
  ...
  "basics.grid1.title": "8 pièces",
  "basics.grid1.p": "Chaque axolotl est assemblé à partir de huit pièces déterminées indépendamment.",
  "basics.grid2.title": "6 raretés",
  "basics.grid2.p": "Commun, Peu commun, Rare, Épique, Légendaire et Xólotl.",
  "basics.grid3.title": "Progression",
  "basics.grid3.p": "Les niveaux d'aquarium débloquent de nouveaux axolotls, graines, capacité et extensions.",
  "basics.grid4.title": "Combat",
  "basics.grid4.p": "Les pièces peuvent accorder des statistiques et des effets d'état.",
  "breeding.title": "Reproduction et héritage des pièces",
  "breeding.p1": "When two axolotls reproduce, every one of their eight pieces is resolved independently.",
  "breeding.mother": "35% Mère",
  "breeding.father": "35% Père",
  ...
  "breeding.genderTitle": "Sexe à la naissance",
  "breeding.genderP": "Chaque nouveau-né a <strong>50% de chances d'être femelle</strong> et <strong>50% d'être mâle</strong>.",
  "timers.title": "Temps de reproduction et coût en gemmes",
  ...
  "timers.rarity": "Rareté maximale",
  "timers.time": "Temps",
  "timers.cost": "Coût pour passer",
  "coins.title": "Pièces",
  ...
  "coins.earnTitle": "Comment gagner des pièces",
  ...
  "coins.breedTitle": "Coût de reproduction",
  ...
  "coins.otherTitle": "Autres utilisations",
  ...
  "gems.earnTitle": "Comment gagner des gemmes",
  ...
  "gems.spendTitle": "Comment dépenser les gemmes",
  ...
  "food.title": "Phytoplancton, nourriture et croissance",
  ...
  "food.favTitle": "Nourriture préférée",
  ...
  "food.seedTitle": "Déblocage des graines",
  ...
  "shop.title": "Boutique de graines",
  ...
  "shop.howTitle": "Fonctionnement de la boutique",
  ...
  "shop.groupsTitle": "Groupes de graines",
  ...
  "shop.slotsTitle": "Emplacements de la boutique",
  ...
  "shop.level": "Niveau d'aquarium",
  "shop.slots": "Emplacements",
  ...
  "visitors.title": "Le visiteur quotidien",
  ...
  "visitors.genTitle": "Génération du visiteur quotidien",
  ...
  "visitors.unlocked": "Raretés débloquées",
  "visitors.chance": "Chance par rareté",
  ...
  "love.rarity": "Rareté de la pièce",
  ...
  "love.multipleTitle": "Lorsque plusieurs ennemis acceptent",
  ...
  "levels.title": "Niveaux d'aquarium et progression",
  ...
  "effects.title": "Effets de statut",
  ...
  "effects.effect": "Effet",
  "effects.result": "Résultat",
  "abilities.title": "Capacités des pièces d'axolotl",
  ...
  "legal.title": "Politique de confidentialité et copyright",
  ...
  "legal.copyTitle": "Copyright et propriété intellectuelle",
