export default {
  "lang": "zh-CN",
  "languageLabel": "语言",
  "pageTitle": "Only Axolotls — 官方游戏指南",
  ...
  "hero.subtitle": "了解水族箱、蝾螈、繁殖、战斗、成长进度和概率所需的一切信息。",
  "hero.note": "本指南介绍当前最终版游戏系统和数值。",
  ...
  "basics.grid1.title": "8个部件",
  "basics.grid1.p": "每只蝾螈由8个独立决定的部件组成。",
  "basics.grid2.title": "6种稀有度",
  "basics.grid2.p": "普通、不普通、稀有、史诗、传奇和 Xólotl。",
  "basics.grid3.title": "成长",
  "basics.grid3.p": "水族箱等级会解锁新的蝾螈、种子、容量和扩建。",
  "basics.grid4.title": "战斗",
  "basics.grid4.p": "部件可以提供属性和状态效果。",
  "breeding.title": "繁殖与部件继承",
  "breeding.p1": "When two axolotls reproduce, every one of their eight pieces is resolved independently.",
  "breeding.mother": "母体 35%",
  "breeding.father": "父体 35%",
  "breeding.mutation": "突变 30%",
  ...
  "breeding.genderTitle": "出生性别",
  "breeding.genderP": "每只新生蝾螈有<strong>50%概率为雌性</strong>，<strong>50%概率为雄性</strong>。",
  "timers.title": "繁殖时间与宝石消耗",
  ...
  "visitors.unlocked": "已解锁稀有度",
  "visitors.chance": "每种稀有度概率",
