export default {
  ...
  "pageTitle": "Only Axolotls — Guia Oficial do Jogo",
  "description": "Official Only Axolotls game guide — mechanics, breeding, probabilities, levels, axolotl abilities, effects and more.",
  "hero.eyebrow": "GUIA OFICIAL DO JOGO",
  "hero.title": "Only Axolotls",
  "hero.subtitle": "Tudo o que precisa de saber sobre o seu aquário, axolotes, reprodução, batalhas, progressão e probabilidades.",
  "hero.note": "Este guia descreve os sistemas e valores atuais da versão final do jogo.",
  "basics.title": "Como funciona Only Axolotls",
  ...
  "basics.grid1.title": "8 peças",
  "basics.grid1.p": "Cada axolote é composto por oito peças determinadas de forma independente.",
  "basics.grid2.title": "6 raridades",
  "basics.grid2.p": "Comum, Incomum, Rara, Épica, Lendária e Xólotl.",
  "basics.grid3.title": "Progressão",
  "basics.grid3.p": "Os níveis do aquário desbloqueiam novos axolotes, sementes, capacidade e expansões.",
  "basics.grid4.title": "Combate",
  "basics.grid4.p": "As peças podem conceder estatísticas e efeitos de estado.",
  "breeding.title": "Reprodução e herança de peças",
  "breeding.p1": "When two axolotls reproduce, every one of their eight pieces is resolved independently.",
  "breeding.mother": "35% Mãe",
  "breeding.father": "35% Pai",
  "breeding.mutation": "30% Mutação",
  ...
  "breeding.genderTitle": "Sexo ao nascer",
  "breeding.genderP": "Cada recém-nascido tem <strong>50% de probabilidade de ser fêmea</strong> e <strong>50% de ser macho</strong>.",
  "timers.title": "Tempo de reprodução e custo em gemas",
  ...
  "timers.rarity": "Maior raridade",
  "timers.time": "Tempo",
  "timers.cost": "Custo para ignorar",
  "coins.title": "Moedas",
  ...
  "coins.earnTitle": "Como ganhar moedas",
  ...
  "coins.breedTitle": "Custo da reprodução",
  ...
  "coins.otherTitle": "Outras utilizações",
  ...
  "gems.earnTitle": "Como ganhar gemas",
  ...
  "gems.spendTitle": "Como gastar gemas",
  ...
  "food.title": "Fitoplâncton, comida e crescimento",
  ...
  "shop.howTitle": "Como funciona a loja",
  ...
  "shop.groupsTitle": "Grupos de sementes",
  ...
  "shop.slotsTitle": "Espaços da loja",
  ...
  "visitors.title": "O visitante diário",
  ...
  "visitors.genTitle": "Geração do visitante diário",
  ...
  "visitors.unlocked": "Raridades desbloqueadas",
  "visitors.chance": "Probabilidade por raridade",
  ...
  "love.title": "O axolote apaixonado",
  ...
  "love.rarity": "Raridade da peça",
  "love.contribution": "Contribuição",
  ...
  "love.multipleTitle": "Quando vários inimigos aceitam",
  ...
  "levels.title": "Níveis do aquário e progressão",
  ...
  "effects.title": "Efeitos de estado",
  ...
  "abilities.title": "Habilidades das peças dos axolotes",
  ...
  "legal.title": "Política de Privacidade e Copyright",
  ...
  "legal.copyTitle": "Copyright e Propriedade Intelectual",
